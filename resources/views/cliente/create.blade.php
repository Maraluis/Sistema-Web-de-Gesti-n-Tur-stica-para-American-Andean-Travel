                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="form-select" id="tipo_documento" name="tipo_documento">
                                    <option value="" disabled {{ old('tipo_documento') === null ? 'selected' : '' }}>
                                        Seleccione una opción</option>
                                    <option value="dni" {{ old('tipo_documento') === 'dni' ? 'selected' : '' }}>DNI
                                    </option>
                                    <option value="carnet" {{ old('tipo_documento') === 'carnet' ? 'selected' : '' }}>Carnet
                                        de Extranjería</option>
                                    <option value="pasaporte"
                                        {{ old('tipo_documento') === 'pasaporte' ? 'selected' : '' }}>Pasaporte</option>
                                    <option value="ptp" {{ old('tipo_documento') === 'ptp' ? 'selected' : '' }}>Permiso
                                        Temporal de Permanencia (PTP)</option>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="documento" name="documento"
                                    placeholder="Ingrese el número" value="{{ old('documento') }}">
                                @error('documento')
                                    <small class="text-danger">*.{{ $message }}</small>
                                @enderror
                            </div>
