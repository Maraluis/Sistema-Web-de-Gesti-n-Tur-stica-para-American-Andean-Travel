...
<?php $__env->startSection('title', 'Dashboard - American Andean Travel'); ?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6 mb-4">
                        <a href="<?php echo e(route('clientes.index')); ?>" class="clickable-card">
                    ...
                    <!--begin::Col - Guías-->
                    <div class="col-lg-3 col-6 mb-4">
                        <a href="<?php echo e(route('guias.index')); ?>" class="clickable-card">
                            <div class="small-box text-bg-success stat-card">
                                <div class="inner">
                                    <h3><?php echo e($totalGuias); ?></h3>
                                    <p>Guías</p>
                                </div>
                                <svg class="small-box-icon" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    viewBox="0 0 24 24">
                    ...
                    <!--begin::Col - Reservas-->
                    <div class="col-lg-3 col-6 mb-4">
                        <a href="<?php echo e(route('reservas.index')); ?>" class="clickable-card">
                            <div class="small-box text-bg-warning stat-card">
                                <div class="inner">
                                    <h3><?php echo e($totalReservas); ?></h3>
                                    <p>Reservas</p>
                                </div>
                                <svg class="small-box-icon" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    viewBox="0 0 24 24">
                    ...
                    <!--begin::Col - Paquetes-->
                    <div class="col-lg-3 col-6 mb-4">
                        <a href="<?php echo e(route('paquetes.index')); ?>" class="clickable-card">
                            <div class="small-box text-bg-danger stat-card">
                                <div class="inner">
                                    <h3><?php echo e($totalPaquetes); ?></h3>
                                    <p>Paquetes</p>
                                </div>
                                <svg class="small-box-icon" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    viewBox="0 0 24 24">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6 mb-4">
                        <a href="<?php echo e(route('transportes.index')); ?>" class="clickable-card">
                            <div class="info-box bg-info">
                                <span class="info-box-icon"><i class="bi bi-truck"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">Transportes</span>
                                    <span class="info-box-number"><?php echo e($totalTransportes); ?></span>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <!--begin::Col - Hoteles-->
                    <div class="col-lg-3 col-6 mb-4">
                        <a href="<?php echo e(route('hoteles.index')); ?>" class="clickable-card">
                            <div class="info-box bg-secondary">
                                <span class="info-box-icon"><i class="bi bi-building"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">Hoteles</span>
                                    <span class="info-box-number"><?php echo e($totalHoteles); ?></span>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-3 col-6 mb-4">
                        <a href="<?php echo e(route('restaurantes.index')); ?>" class="clickable-card">
                            <div class="info-box bg-light">
                                <span class="info-box-icon text-dark"><i class="bi bi-cup-hot"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">Restaurantes</span>
                                    <span class="info-box-number"><?php echo e($totalRestaurantes); ?></span>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="<?php echo e(route('reservas.index')); ?>" class="clickable-card">
                            <div class="info-box bg-gradient-primary">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number"><?php echo e($reservasHoy); ?></span>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h2 class="text-primary">S/ <?php echo e(number_format($ingresosMes, 2)); ?></h2>
                                <p class="text-muted mb-1">Reservas este mes: <strong><?php echo e($reservasMesActual); ?></strong></p>
                                    ...
                                    <table class="table table-striped table-hover mb-0">
                                        ...
                                        <tbody>
                                            <?php $__empty_1 = true; $__currentLoopData = $ultimasReservas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reserva): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr>
                                                    <td><?php echo e($reserva->cliente->nombre); ?></td>
                                                    <td><?php echo e(Str::limit($reserva->paquete->nombre, 30)); ?></td>
                                                    <td><?php echo e(\Carbon\Carbon::parse($reserva->fecha_inicio)->format('d/m/Y')); ?></td>
                                                    <td>
                                                    ...
                                                    <td><strong>S/ <?php echo e(number_format($reserva->precio_total, 2)); ?></strong></td>
                                                </tr>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <?php $__empty_1 = true; $__currentLoopData = $paquetesPopulares; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paquete): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="col-md-3 mb-3">
                                            <div class="card h-100 shadow-sm">
                                                <?php if($paquete->imagen): ?>
                                                    <img src="<?php echo e(asset('storage/' . $paquete->imagen)); ?>" 
                                                         class="card-img-top" 
                                                ...
                                                <?php endif; ?>
                                                <div class="card-body">
                                                    <h5 class="card-title text-truncate" title="<?php echo e($paquete->nombre); ?>">
                                                        <?php echo e($paquete->nombre); ?>

                                                    </h5>
                                                    <p class="card-text">
                                                        <small class="text-muted">
                                                            <i class="bi bi-calendar3"></i> <?php echo e($paquete->duracion); ?> días
                                                        </small>
                                                    </p>
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <span class="badge bg-primary">
                                                            <?php echo e($paquete->reservas_count); ?> reservas
                                                        </span>
                                                        <strong class="text-success">
                                                            S/ <?php echo e(number_format($paquete->precio, 2)); ?>
...
<?php echo $__env->make('template', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\gestion-paquetes - copia\resources\views/panel/index.blade.php ENDPATH**/ ?>